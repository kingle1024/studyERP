...
<div class="row">
						...
						<div class="list-group">
							<c:forEach var="myMessage" items="${myMessages}"
								...
								<a href="#" class="list-group-item"> <span class="badge">${ messageTime[status.index]}</span>
									<i class="fa fa-fw fa-comment"></i>${ myMessage.title }
								</a>
							</c:forEach>
						</div>
						<div class="text-right">
    ...
    <script src="theme2/vendor/popper/popper.min.js"></script>
    <script src="theme2/vendor/bootstrap/js/bootstrap.min.js"></script>

    <!-- Plugin JavaScript -->
    <script src="theme2/vendor/jquery-easing/jquery.easing.min.js"></script>
    <script src="theme2/vendor/chart.js/Chart.min.js"></script>
    <script src="theme2/vendor/datatables/jquery.dataTables.js"></script>
    <script src="theme2/vendor/datatables/dataTables.bootstrap4.js"></script>

    <!-- Custom scripts for this template -->
    <script src="theme2/js/sb-admin.min.js"></script>
